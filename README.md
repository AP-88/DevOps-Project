...
This project is configured to run seamlessly using Docker and Docker Compose, pulling the pre-built image from Docker Hub.
...
please run: docker pull ap88/python-flask:002
